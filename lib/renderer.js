...
class Renderer extends EventEmitter {
  constructor(content, opts) {
    ...
    !function(_hook) {
      if (_hook.preinsert && typeof _hook.preinsert === 'function')
        this.on('preinsert', _hook.preinsert);

      if (_hook.prewrap && typeof _hook.prewrap === 'function')
        this.on('prewrap', _hook.prewrap);
    }.call(this, this.opts.hook);
  }
